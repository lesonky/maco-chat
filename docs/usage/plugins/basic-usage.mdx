...
The plugin system is a key element in expanding the capabilities of assistants in MacoChat. You can enhance the assistant's abilities by enabling a variety of plugins.

Watch the following video to quickly get started with using MacoChat plugins:
...
The Plugin Store allows you to directly install and use plugins within MacoChat.

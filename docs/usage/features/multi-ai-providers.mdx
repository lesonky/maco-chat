...
To meet the specific needs of users, MacoChat also supports the use of local models based on [Ollama](https://ollama.ai), allowing users to flexibly use their own or third-party models. For more details, see [Local Model Support](/zh/features/local-llm).

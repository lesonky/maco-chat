...
# Using Ollama in MacoChat

<Image
  alt={'Using Ollama in MacoChat'}
...
This document will guide you on how to use Ollama in MacoChat:
...
Next, you can start conversing with the local LLM using MacoChat.
...
<Callout type={'info'}>
  ...
  MacoChat to meet the integration requirements with Ollama.
</Callout>

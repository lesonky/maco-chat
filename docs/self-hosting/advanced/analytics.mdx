...
To better help analyze the usage of MacoChat users, we have integrated several free/open-source data analytics services in MacoChat for collecting user usage data, which you can enable as needed.

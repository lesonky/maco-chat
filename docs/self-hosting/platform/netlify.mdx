...
# Deploy MacoChat with Netlify

If you want to deploy MacoChat on Netlify, you can follow these steps:

## Deploy MacoChat with Netlify

<Steps>

### Fork the MacoChat Repository

Click the Fork button to fork the MacoChat repository to your GitHub account.
...
Next, select the MacoChat project:

<Image
  alt={'Select the MacoChat github project'}
...
<Image
  alt={'Configure MacoChat site name'}
...
<Image
  alt={'Add MacoChat site environment variables'}
...
<Callout type={'info'}>
  For a complete list of environment variables supported by MacoChat, please refer to the [📘
...
Upon entering the deployment details, you will see the following interface, indicating that your MacoChat is currently being deployed. Simply wait for the deployment to complete.

<Image
  alt={'MacoChat deployment in progress'}
...
If your Deploy Log in the interface looks like the following, it means your MacoChat has been successfully deployed.
...
<Image
  ...
  height={558}
/>
At this point, you can click on "Open production deploy" to access your MacoChat site.

<Image
  alt={'Access Your MacoChat Site'}

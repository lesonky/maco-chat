...
import { AgentsMarketItem, MacoChatAgentsMarketIndex } from '@/types/market';
...
export interface StoreAction {
  ...
  useFetchAgentList: () => SWRResponse<MacoChatAgentsMarketIndex>;
}
...
> = (set, get) => ({
  ...
  useFetchAgentList: () =>
    useSWR<MacoChatAgentsMarketIndex>(

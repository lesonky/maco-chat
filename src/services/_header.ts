import { MACO_CHAT_ACCESS_CODE, OPENAI_API_KEY_HEADER_KEY, OPENAI_END_POINT } from '@/const/fetch';
...
export const createHeaderWithOpenAI = (header?: HeadersInit): HeadersInit => {
  ...
  return {
    ...header,
    [MACO_CHAT_ACCESS_CODE]: settingsSelectors.password(useGlobalStore.getState()),

...
Welcome to the MacoChat Internationalization Implementation Guide. This document will guide you through understanding the internationalization mechanism of MacoChat, including file structure and how to add new languages. MacoChat uses `i18next` and `lobe-i18n` as the internationalization solution, aiming to provide users with seamless multilingual support.
...
Internationalization (i18n for short) is the process of enabling an application to adapt to different languages and regions. In MacoChat, we support multiple languages and achieve dynamic language switching and content localization through the `i18next` library. Our goal is to provide a localized experience for global users.

## File Structure

In the MacoChat project, internationalization-related files are organized as follows:
...
The internationalization core implementation logic of MacoChat is as follows:
...
Here is a simplified pseudo code example to illustrate the core implementation logic of internationalization in MacoChat:
...
By following this guide, you can better understand and participate in the internationalization work of MacoChat, providing a seamless multilingual experience for global users.

...
Upgrading the Docker deployment version is very simple, just redeploy the latest image of MacoChat. Here are the instructions to perform these steps:

1. Stop and delete the currently running MacoChat container (assuming the name of the MacoChat container is `lobe-chat`):
...
2. Pull the latest Docker image of MacoChat:

```fish
docker pull lobehub/lobe-chat
```

3. Redeploy the MacoChat container using the newly pulled image:
...
>
> Don't worry, all of MacoChat's chat history is stored in your local browser. Therefore, when you redeploy MacoChat using Docker, your chat history will not be lost.

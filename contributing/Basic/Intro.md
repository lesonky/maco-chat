...
Welcome to the MacoChat technical development getting started guide. MacoChat is an AI conversation application built on the Next.js framework, which integrates a series of technology stacks to achieve diverse functions and features. This guide will provide a detailed introduction to the main technical components of MacoChat and how to configure and use these technologies in your development environment.
...
The core technology stack of MacoChat includes:
...
The folder directory structure of MacoChat is as follows:
